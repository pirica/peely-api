...
async def GenerateShopImage(Store):
    ...
    Middle = GetMiddle(Background.width, BurbankBigCondensed.getsize("Fortnite Item Shop")[0])
    Draw.text((Middle, 0), "Fortnite Item Shop", (255, 255, 255), font=BurbankBigCondensed)
